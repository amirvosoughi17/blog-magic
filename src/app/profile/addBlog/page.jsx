        ...
        <div className="w-full py-5 px-10">
          <div className="w-full h-full  bg-white rounded-md py-3 px-4 shadow-sm">
            <div className="flex flex-col items-center  ">
              ...
              <div className="">
                <form className='flex flex-col my-10 gap-2' method="post" onSubmit={handleSubmit}>
                  ...
                  <div className="flex flex-col gap-1 ">
                    <label htmlFor="title" className='text-slate-800 '>Description</label>
                  ...
                  <select name="category" value={formData.category} className= ' w-[270px] bg-zinc-100/40 py-[6px] px-2 rounded-sm border-[1px] border-zinc-400/30 mb-7' onChange={handleChange}>
                      <option value="software">software</option>
                      <option value="hardware">hardware</option>
                      <option value="ai">Ai</option>
                  </select>
                  </div>
                  <button type='submit' className='w-[270px] bg-emerald-500 py-[5px] rounded text-emerald-900 border-[1px] border-emerald-600 cursor-pointer'>{loading ? "Loading..." : "Create"}</button>
                </form>
              </div>
            </div>
          </div>
